...
class RoomController extends AbstractController
{
    ...
    {
        return $this->render('pages/admin/room/index.html.twig', [
    ...
    public function new(Request $request, RoomRepository $roomRepository): Response
    {
        ...
        return $this->render('pages/admin/room/new.html.twig', [
            'room' => $room,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('pages/admin/room/show.html.twig', [
            'room' => $room,
        ]);
    }
    ...
    public function edit(Request $request, Room $room, RoomRepository $roomRepository): Response
    {
        ...
        return $this->render('pages/admin/room/edit.html.twig', [
            'room' => $room,
            'form' => $form,
        ]);
    }
